...
void GImage::aniRender(HDC hdc, int destX, int destY, int destWidth, int destHeight, Animation* ani)
{
	render(hdc, destX, destY, destWidth, destHeight, ani->getFramePos().x, ani->getFramePos().y, ani->getFrameWidth(), ani->getFrameHeight());
}
